            ...
            <table id="table">
                ...
                <tbody>
                    ...
                    foreach ($data['kd11'] as $row) {
                        ...
                        echo '<br>';
                        echo '<tr>';
                        echo '<td align=center; colspan=6; style="font-size: 14; font-weight:900">' . 'KD11' . '</td>';
                        echo '<td align=center; colspan=6; style="font-size: 14; font-weight:900">' . 'KD11 Modify' . '</td>';
                        echo '</tr>';
                        echo '<tr>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->association_no1_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Association' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->sd1_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'SD' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->sg1_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'SG' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->central_regu1_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Central Regu' . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . ($row->central_regu1 = $row->central_regu1 != '' ? $row->central_regu1 : '-' . '</td>');
                        echo '</tr>';
                        echo '<tr>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Conditions' . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->conditions1_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Conditions' . '</td>';
