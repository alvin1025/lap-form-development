            ...
            <table id="table">
                ...
                <tbody>
                    ...
                    foreach ($data['kd06'] as $row) {
                        ...
                        echo '<br>';
                        echo '<tr>';
                        echo '<td align=center; colspan=6; style="font-size: 14; font-weight:900">' . 'KD06' . '</td>';
                        echo '<td align=center; colspan=6; style="font-size: 14; font-weight:900">' . 'KD06 Modify' . '</td>';
                        echo '</tr>';
                        echo '<tr>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->sd_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'SD' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->kd6sg_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'SG' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->sales_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Sales' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10; ">' . substr($row->payterm_old, 5, 20) . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Payterm' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->assigment_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Assignment' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . substr($row->kd6tax_old, 10, 20) . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Tax' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->del_con_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Del Term' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->kurs_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Kurs' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->satuan_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Satuan' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->biz_type_p_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Bisnis Type' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->nama_agent1_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Nama Agent' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->staff_member_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Staff Member' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->allowance_qty_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . '%-Com' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->from_old = $row->from_old != '' ? date('d-m-Y', strtotime($row->from_old)) : ''. '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Validation From' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->to_old = $row->to_old != '' ? date('d-m-Y', strtotime($row->to_old)) : '' . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Validation To' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->pc_old . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Percent' . '</td>';
                        ...
                        echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900">' . 'Print' . '</td>';
                        echo '<td align=left; colspan=3; style="font-size: 10;">' . ($row->print = $row->print != '' ? $row->print : '-' . '</td>');
                        echo '</tr>';
