    ...
    <form action="{{ route('peringatan.update', ['peringatan' => $peringatan->id]) }}" method="post">
            ...
            <h5 class="text-center">
                <div class="col-sm-5">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="no" value="{{ $peringatan->no }}">
                        </div>
                    </div>
                </div>
            </h5>
        ...
        <div class="d-flex justify-content-start">
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 my-2">
                        <input id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror"
                            name="jabatan" value="{{ $peringatan->jabatan }}" />
                        @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 my-2">
                        <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror"
                            name="bagian" value="{{ $peringatan->bagian }}" />
                        @error('bagian')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-3 my-2">
                        <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror"
                            name="divisi" value="{{ $peringatan->divisi }}" />
                        @error('divisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <textarea name="alasan" id="" cols="50" rows="5" class="form-control">{!! $peringatan->alasan !!} </textarea>
                @error('alasan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
