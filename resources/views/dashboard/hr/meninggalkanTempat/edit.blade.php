                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-1">
                            <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                name="tanggal" value="{{ $meninggalkan->tanggal }}" />
                            @error('tanggal')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-1">
                            <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror"
                                name="nama" value="{{ $meninggalkan->nama }}" />
                            @error('nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-1">
                            <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror"
                                name="bagian" value="{{ $meninggalkan->bagian }}" />
                            @error('bagian')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 my-1">
                            <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror"
                                name="divisi" value="{{ $meninggalkan->divisi }}" />
                            @error('divisi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-1">
                            <input id="ijin_dari" type="text" class="form-control @error('ijin_dari') is-invalid @enderror"
                                name="ijin_dari" value="{{ $meninggalkan->ijin_dari }}" />
                            @error('ijin_dari')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 my-1">
                            <input id="sampai" type="text" class="form-control @error('sampai') is-invalid @enderror"
                                name="sampai" value="{{ $meninggalkan->sampai }}" />
                            @error('sampai')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
