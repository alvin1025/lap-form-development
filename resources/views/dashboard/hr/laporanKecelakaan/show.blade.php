                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-2">
                            <input id="nama_penderita" type="text"
                                ...
                                value="{{ $kecelakaan->nama_penderita }}" readonly />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-2">
                            <input id="tgl_lahir" type="text" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                name="tgl_lahir" value="{{ $kecelakaan->tgl_lahir }}" readonly />
                            @error('tgl_lahir')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 my-2">
                            <input id="job_code" type="text" class="form-control @error('job_code') is-invalid @enderror"
                                name="job_code" value="{{ $kecelakaan->job_code }}" readonly />
                            @error('job_code')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
            ...
            <div class="d-flex justify-content-start">
                <div class="col-sm-7">
                    <div class="row">
                        ...
                        <div class="col-sm-7 my-2">
                            <input id="no_jamsostek" type="text" readonly
                ...
                <div class="col-sm-7">
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <textarea name="tempat_tinggal" readonly class="form-control  @error('tempat_tinggal') is-invalid @enderror" id=""
                                cols="20" rows="5">{{ $kecelakaan->tempat_tinggal }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror"
                                name="bagian" value="{{ $kecelakaan->bagian }}" readonly />
                            @error('bagian')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <input id="tempat_kecelakaan" type="text"
                                ...
                                name="tempat_kecelakaan" value="{{ $kecelakaan->tempat_kecelakaan }}" readonly />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <input id="tanggal_kecelakaan" type="text"
                                ...
                                name="tanggal_kecelakaan" value="{{ $kecelakaan->tanggal_kecelakaan }}" readonly />
                ...
                <div class="col-sm-7">
                    <div class="row">
                        ...
                        <label class="col-sm-3 col-form-label my-2" style="font-size: 11px">Sebab-Sebab Kecelakaan (Jelaskan
                            ...
                            akhir)</label>
                        <div class="col-sm-8 my-2">
                            <textarea name="sebab_kecelakaan" readonly class="form-control @error('sebab_kecelakaan') is-invalid @enderror" id=""
                                cols="30" rows="10">{{ $kecelakaan->sebab_kecelakaan }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <input id="keterangan_luka" type="text"
                                class="form-control @error('keterangan_luka') is-invalid @enderror" readonly
                                name="keterangan_luka" value="{{ $kecelakaan->keterangan_luka }}" />
            ...
            <div class="d-flex justify-content-between">
                <div class="col-sm-7">
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <input id="penolong" type="text" readonly
                                class="form-control @error('penolong') is-invalid @enderror" name="penolong"
                                value="{{ $kecelakaan->penolong }}" />
                            @error('penolong')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
            ...
            <div class="d-flex justify-content-between">
                <div class="col-sm-7">
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <input id="dirawat_di" type="text" readonly
            ...
            <div class="d-flex justify-content-between">
                <div class="col-sm-7">
                    <div class="row">
                        ...
                        <div class="col-sm-8 my-2">
                            <textarea readonly name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="" cols="20"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 my-2">
                            <input id="tgl_dibuat" type="date"
                                ...
                                value="{{ $kecelakaan->tgl_dibuat }}" readonly />
                            @error('tgl_dibuat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
