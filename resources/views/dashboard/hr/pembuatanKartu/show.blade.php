                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 my-1">
                        <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror"
                            name="bagian" value="{{ $kartu->bagian }}" readonly />
                        @error('bagian')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 my-1">
                        <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror"
                            name="divisi" value="{{ $kartu->divisi }}" readonly />
                        @error('divisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="d-flex justify-content-end">
            <div class="col-sm-5">
                <div class="row">
                    ...
                    <div class="col-sm-7 my-1">
                        <input id="divisi" type="date" class="form-control @error('divisi') is-invalid @enderror" name=""
                            readonly />
                        @error('divisi')
                            <div class="invalid-feedback">
                                {{ $message }}
