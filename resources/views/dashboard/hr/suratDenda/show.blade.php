...
@section('content')
    ...
    {{-- <form action="{{ route('denda.update', ['denda' => $denda->id]) }}" method="post">
        @csrf
        @method('put') --}}
    ...
    <div class="row">
        <center>
            <h3 class="" style="font-weight: bold">SURAT PERSETUJUAN DENDA</h3>
        </center>
        <center>
            <h5>
                <div class="col-sm-5">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="no" value="{{ $denda->no }}" readonly>
                        </div>
                    </div>
                </div>
            </h5>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 my-2">
                    <input id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror"
                        name="jabatan" value="{{ $denda->jabatan }}" readonly />
                    @error('jabatan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 my-2">
                    <input id="berlaku" type="date" class="form-control @error('berlaku') is-invalid @enderror"
                        name="berlaku" value="{{ $denda->berlaku }}" readonly />
                    @error('berlaku')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
