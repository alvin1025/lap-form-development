            ...
            <h5 class="text-center">
                <div class="col-sm-5">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="no" value="{{ $denda->no }}">
                        </div>
                    </div>
                </div>
            </h5>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 my-2">
                        <input id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror"
                            name="jabatan" value="{{ $denda->jabatan }}" />
                        @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 my-2">
                        <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror"
                            name="bagian" value="{{ $denda->bagian }}" />
                        @error('bagian')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-3 my-2">
                        <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror"
                            name="divisi" value="{{ $denda->divisi }}" />
                        @error('divisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 my-2">
                        <input id="berlaku" type="date" class="form-control @error('berlaku') is-invalid @enderror"
                            name="berlaku" value="{{ $denda->berlaku }}" />
                        @error('berlaku')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
