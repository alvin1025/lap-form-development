                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 my-2">
                        <input id="keperluan" type="text" class="form-control @error('keperluan') is-invalid @enderror"
                            name="keperluan" value="{{ $shift->keperluan }}" />
                        @error('keperluan')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror"
                            name="bagian" value="{{ $shift->bagian }}" />
                        @error('bagian')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror"
                            name="divisi" value="{{ $shift->divisi }}" />
                        @error('divisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="bagian2" type="text" class="form-control @error('bagian2') is-invalid @enderror"
                            name="bagian2" value="{{ $shift->bagian2 }}" />
                        @error('bagian2')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="divisi2" type="text" class="form-control @error('divisi2') is-invalid @enderror"
                            name="divisi2" value="{{ $shift->divisi2 }}" />
                        @error('divisi2')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 ">
                        <input type="date" class="form-control @error('masuk_kerja') is-invalid @enderror"
                            name="masuk_kerja" value="{{ $shift->masuk_kerja }}" />
                        @error('masuk_kerja')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
