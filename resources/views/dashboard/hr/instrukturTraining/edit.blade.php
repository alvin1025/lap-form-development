...
@section('content')
    ...
    <form action="{{ route('instruktur.update', ['instruktur' => $training->id]) }}" method="post">
        @csrf
        @method('put')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input id="perihal" type="text" class="form-control @error('perihal') is-invalid @enderror"
                            name="perihal" value="{{ $training->perihal }}" />
                        @error('perihal')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 my-2">
                        <input id="tanggal1" type="date" class="form-control @error('tanggal1') is-invalid @enderror"
                            name="tanggal1" value="{{ $training->tanggal1 }}" />
                        @error('tanggal1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 my-2">
                        <input id="waktu1" type="text" class="form-control @error('waktu1') is-invalid @enderror"
                            name="waktu1" value="{{ $training->waktu1 }}" />
                        @error('waktu1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 my-2">
                        <input id="tempat1" type="text" class="form-control @error('tempat1') is-invalid @enderror"
                            name="tempat1" value="{{ $training->tempat1 }}" />
                        @error('tempat1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 my-2">
                        <input id="peserta1" type="text" class="form-control @error('peserta1') is-invalid @enderror"
                            name="peserta1" value="{{ $training->peserta1 }}" />
                        @error('peserta1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 my-2">
                        <input id="tanggal2" type="date" class="form-control @error('tanggal2') is-invalid @enderror"
                            name="tanggal2" value="{{ $training->tanggal2 }}" />
                        @error('tanggal2')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 my-2">
                        <input id="waktu2" type="text" class="form-control @error('waktu2') is-invalid @enderror"
                            name="waktu2" value="{{ $training->waktu2 }}" />
                        @error('waktu2')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 my-2">
                        <input id="tempat2" type="text" class="form-control @error('tempat2') is-invalid @enderror"
                            name="tempat2" value="{{ $training->tempat2 }}" />
                        @error('tempat2')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 my-2">
                        <input id="peserta2" type="text" class="form-control @error('peserta2') is-invalid @enderror"
                            name="peserta2" value="{{ $training->peserta2 }}" />
                        @error('peserta2')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 my-2">
                        <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                            name="tanggal" value="{{ $training->tanggal }}" />
                        @error('tanggal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
