...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <input id="perihal" type="text" class="form-control @error('perihal') is-invalid @enderror"
                        name="perihal" value="{{ $training->perihal }}" readonly />
                    @error('perihal')
    ...
    <div class="d-flex justify-content-start mt-3">
        <div class="col-sm-10">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <input id="nama_trainer" type="text" class="form-control @error('nama_trainer') is-invalid @enderror"
                        name="nama_trainer" value="{{ $training->nama_trainer }}" readonly />
                    @error('nama_trainer')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
    ...
    <div class="d-flex justify-content-start">
        ...
        <div class="col-sm-3">
            <div class="row">
                <div class="col-sm-11">
                    <input id="nama_training" type="text" class="form-control @error('nama_training') is-invalid @enderror"
                        name="nama_training" value="{{ $training->nama_training }}" readonly />
                    @error('nama_training')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-4 my-2">
                    <input id="hari1" type="text" class="form-control @error('hari1') is-invalid @enderror" name="hari1"
                        value="{{ $training->hari1 }}" readonly />
                    @error('hari1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-sm-4 my-2">
                    <input id="tanggal1" type="date" class="form-control @error('tanggal1') is-invalid @enderror"
                        name="tanggal1" value="{{ $training->tanggal1 }}" readonly />
                    @error('tanggal1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="waktu1" type="text" class="form-control @error('waktu1') is-invalid @enderror" name="waktu1"
                        value="{{ $training->waktu1 }}" readonly />
                    @error('waktu1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="tempat1" type="text" class="form-control @error('tempat1') is-invalid @enderror"
                        name="tempat1" value="{{ $training->tempat1 }}" readonly />
                    @error('tempat1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="peserta1" type="text" class="form-control @error('peserta1') is-invalid @enderror"
                        name="peserta1" value="{{ $training->peserta1 }}" readonly />
                    @error('peserta1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
    ...
    <div class="d-flex justify-content-start">
        <div class="col-sm-6">
            <div class="row">
                <label class="col-sm-4 col-form-label my-2">Hari/Tanggal</label>
                <div class="col-sm-4 my-2">
                    <input id="hari2" type="text" class="form-control @error('hari2') is-invalid @enderror" name="hari2"
                        value="{{ $training->hari2 }}" readonly />
                    @error('hari2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-sm-4 my-2">
                    <input id="tanggal2" type="date" class="form-control @error('tanggal2') is-invalid @enderror"
                        name="tanggal2" value="{{ $training->tanggal2 }}" readonly />
                    @error('tanggal2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
    ...
    <div class="d-flex justify-content-start">
        <div class="col-sm-6">
            <div class="row">
                <label class="col-sm-4 col-form-label my-2">Waktu</label>
                <div class="col-sm-8 my-2">
                    <input id="waktu2" type="text" class="form-control @error('waktu2') is-invalid @enderror" name="waktu2"
                        value="{{ $training->waktu2 }}" readonly />
                    @error('waktu2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="tempat2" type="text" class="form-control @error('tempat2') is-invalid @enderror"
                        name="tempat2" value="{{ $training->tempat2 }}" readonly />
                    @error('tempat2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="peserta2" type="text" class="form-control @error('peserta2') is-invalid @enderror"
                        name="peserta2" value="{{ $training->peserta2 }}" readonly />
                    @error('peserta2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 my-2">
                    <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                        name="tanggal" value="{{ $training->tanggal }}" readonly />
                    @error('tanggal')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
