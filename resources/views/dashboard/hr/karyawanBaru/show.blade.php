            ...
            <div class="row">
                <div class="col-sm-10">
                    <input id="no" type="text" class="form-control @error('no') is-invalid @enderror" name="no"
                        value="{{ $karyawanBaru->no }}" readonly />
                    @error('no')
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                        value="{{ $karyawanBaru->nama }}" readonly />
                    @error('nama')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-4 row">
                ...
                <div class="col-sm-7">
                    <input id="nrp" type="text" class="form-control @error('nrp') is-invalid @enderror" name="nrp"
                        value="{{ $karyawanBaru->nrp }}" readonly />
                    @error('nrp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="mulai_kerja" type="text" class="form-control @error('mulai_kerja') is-invalid @enderror"
                        name="mulai_kerja" value="{{ $karyawanBaru->mulai_kerja }}" readonly />
                    @error('mulai_kerja')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 my-2">
                    <input id="bagian" type="text" class="form-control @error('bagian') is-invalid @enderror" name="bagian"
                        value="{{ $karyawanBaru->bagian }}" readonly />
                    @error('bagian')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-sm-4 my-2">
                    <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror" name="divisi"
                        value="{{ $karyawanBaru->divisi }}" readonly />
                    @error('divisi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 my-2">
                    <input id="level" type="text" class="form-control @error('level') is-invalid @enderror" name="level"
                        value="{{ $karyawanBaru->level }}" readonly />
                    @error('level')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
