...
@section('content')
    ...
    <form action="{{ route('bci.store') }}" method="post">
        @csrf
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-7 my-2">
                    <input type="text" class="form-control @error('ne1_lycra') is-invalid @enderror" name="ne1_lycra" />
                    @error('ne1_lycra')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-7 my-2">
                    <input type="text" class="form-control @error('tpi_pakan') is-invalid @enderror" name="tpi_pakan" />
                    @error('tpi_pakan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="show" id="show">
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-7 my-2">
                        <input type="text" class="form-control @error('ne1_slub') is-invalid @enderror" name="ne1_slub" />
                        @error('ne1_slub')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
