...
@section('title', 'Form ShipmenKind Management')

@section('content')

    <form action="{{ route('shipmentKindManagement.update', ['shipmentKindManagement' => $shipment->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="d-flex justify-content-evenly">
                ...
                <div class="col-sm-6">
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="dispadvgen" type="text"
                                class="form-control @error('dispadvgen') is-invalid @enderror" name="dispadvgen"
                                value="{{ $shipment->dispadvgen }}" />
                            @error('dispadvgen')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
