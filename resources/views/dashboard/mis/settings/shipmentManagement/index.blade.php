...
@section('content')
    ...
    <div class="table-responsive">
        ...
        <div class="d-flex justify-content-start">
            <a href="{{ route('shipmentKindManagement.create') }}" class="btn btn-primary mb-3">Create New Form</a>
            ...
            <tbody>
                @foreach ($shipment as $form)
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/mis/settings/shipmentKindManagement/{{ $form->id }}"
                                class="badge bg-info"><i class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="/dashboard/mis/settings/shipmentKindManagement/{{ $form->id }}/edit"
                                class="badge bg-warning"><i class="fas fa-edit"></i></a>
                            <form action="/dashboard/mis/settings/shipmentKindManagement/{{ $form->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
