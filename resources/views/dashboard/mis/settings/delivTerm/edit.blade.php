...
@section('content')
    ...
    <form action="{{ route('delivTerm.update', ['delivTerm' => $delivTerm->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
        ...
        <div class="container">
            <div class="d-flex justify-content-center">
                <label class="col-sm-2 col-form-label my-2">Delivery Term</label>
                <div class="col-sm-5 my-2">
                    <input id="key" type="text" class="form-control @error('key') is-invalid @enderror"
                        name="key" value="{{ $delivTerm->key }}" />
                    @error('key')
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" value="{{ $delivTerm->description }}" />
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
