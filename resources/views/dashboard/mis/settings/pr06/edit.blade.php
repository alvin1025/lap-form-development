...
@section('content')
    ...
    <form action="{{ route('pr06.update', ['pr06' => $pr06->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="pricegrp" type="text" class="form-control @error('pricegrp') is-invalid @enderror"
                        name="pricegrp" value="{{ $pr06->pricegrp }}" />
                    @error('pricegrp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="article" type="text" class="form-control @error('article') is-invalid @enderror"
                        name="article" value="{{ $pr06->article }}" />
                    @error('article')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="surcharge_no" type="text" class="form-control @error('surcharge_no') is-invalid @enderror"
                        name="surcharge_no" value="{{ $pr06->surcharge_no }}" />
                    @error('surcharge_no')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="surch_red" type="text" class="form-control @error('surch_red') is-invalid @enderror"
                        name="surch_red" value="{{ $pr06->surch_red }}" />
                    @error('surch_red')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
