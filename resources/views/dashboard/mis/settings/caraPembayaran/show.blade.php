    ...
    <div class="container">
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="cara_pembayaran" type="text" class="form-control @error('cara_pembayaran') is-invalid @enderror"
                    name="cara_pembayaran" value="{{ $caraPembayaran->cara_pembayaran }}" readonly />
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                    name="description" value="{{ $caraPembayaran->description }}" readonly />
                @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
