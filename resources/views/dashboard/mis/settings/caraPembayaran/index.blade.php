...
@section('content')
    ...
    <div class="table-responsive">
        ...
        <div class="d-flex justify-content-start">
            <a href="{{ route('caraPembayaran.create') }}" class="btn btn-primary mb-3">Create New Form</a>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('importCaraPembayaran') }}" method="post" enctype="multipart/form-data">
                            @csrf
        ...
        <table class="table table-light table-striped" id="dt-init">
            ...
            <tbody>
                @foreach ($caraPembayaran as $form)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $form->cara_pembayaran }}</td>
                        <td>{{ $form->description }}</td>
                        <td>
                            <a href="/dashboard/mis/settings/caraPembayaran/{{ $form->id }}" class="badge bg-info"><i
                                    class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="/dashboard/mis/settings/caraPembayaran/{{ $form->id }}/edit"
                                class="badge bg-warning"><i class="fas fa-edit"></i></a>
                            <form action="/dashboard/mis/settings/caraPembayaran/{{ $form->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
