...
@section('content')
    ...
    <div class="table-responsive">
        <div class="d-flex justify-content-start">
            <a href="{{ route('assignment.create') }}" class="btn btn-primary mb-3">Create New Form</a>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('importAssignment') }}" method="post" enctype="multipart/form-data">
                            @csrf
            ...
            <tbody>
                @foreach ($assignment as $form)
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/mis/settings/assignment/{{ $form->id }}" class="badge bg-info"><i
                                    class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="/dashboard/mis/settings/assignment/{{ $form->id }}/edit"
                                class="badge bg-warning"><i class="fas fa-edit"></i></a>
                            <form action="/dashboard/mis/settings/assignment/{{ $form->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
