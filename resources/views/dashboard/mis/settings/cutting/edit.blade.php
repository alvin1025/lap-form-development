        ...
        <div class="container">
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="cutting" type="text" class="form-control @error('cutting') is-invalid @enderror"
                        name="cutting" value="{{ $cutting->cutting }}" />
                    @error('cutting')
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" value="{{ $cutting->description }}" />
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
