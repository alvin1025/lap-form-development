...
@section('content')
    ...
    <div class="table-responsive">
        ...
        <div class="d-flex justify-content-start">
            <a href="{{ route('clm.create') }}" class="btn btn-primary mb-3">Create New Form</a>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('importClm') }}" method="post" enctype="multipart/form-data">
                            @csrf
            ...
            <tbody>
                @foreach ($clm as $form)
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/mis/settings/clm/{{ $form->id }}" class="badge bg-info"><i
                                    class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="/dashboard/mis/settings/clm/{{ $form->id }}/edit" class="badge bg-warning"><i
                                    class="fas fa-edit"></i></a>
                            <form action="/dashboard/mis/settings/clm/{{ $form->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
