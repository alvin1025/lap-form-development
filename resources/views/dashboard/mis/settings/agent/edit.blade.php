...
@section('content')
    ...
    <form action="{{ route('agentmaster.update', ['agentmaster', $agent->id]) }}" method="POST">
        @csrf
        @method('put')
        <h6 class="text-left mt-3">Agent</h6>
        <hr>
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="name1" type="text" class="form-control @error('name1') is-invalid @enderror"
                                    name="name1" value="{{ $agent->name1 }}" />
                                @error('name1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="name2" type="text" class="form-control @error('name2') is-invalid @enderror"
                                    name="name2" value="{{ $agent->name2 }}" />
                                @error('name2')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="street" type="text" class="form-control @error('street') is-invalid @enderror"
                                    name="street" value="{{ $agent->street }}" />
                                @error('street')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 13px">Additional
                                    Address</label>
                            </div>
                            <div class="col-sm-8">
                                <input id="addit" type="text" class="form-control @error('addit') is-invalid @enderror"
                                    name="addit" value="{{ $agent->addit }}" />
                                @error('addit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 13px">Kurs</label>
                            </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-5">
                                <label type="text" name="" id="" class="form-label text-center">Agent</label>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="text" type="text" class="form-control @error('pobox') is-invalid @enderror"
                                    name="pobox" value="{{ $agent->pobox }}" />
                                @error('pobox')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-3">
                                <a href="{{ route('kd3.index') }}" class="btn btn-danger">BACK</a>
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="col-sm-8">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 13px">Country
                                    Code</label>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 15px">Agent Kind
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="cty" type="text" class="form-control @error('cty') is-invalid @enderror"
                                    name="cty" value="{{ $agent->cty }}" />
                                @error('cty')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
