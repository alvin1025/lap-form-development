...
@section('content')
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="pricegrp" type="text" class="form-control @error('pricegrp') is-invalid @enderror"
                    name="pricegrp" value="{{ $pr04->pricegrp }}" readonly />
                @error('pricegrp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="serno" type="text" class="form-control @error('serno') is-invalid @enderror"
                    name="serno" value="{{ $pr04->serno }}" readonly />
                @error('serno')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="article" type="text" class="form-control @error('article') is-invalid @enderror"
                    name="article" value="{{ $pr04->article }}" readonly />
                @error('article')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="tariff_code" type="text" class="form-control @error('tariff_code') is-invalid @enderror"
                    name="tariff_code" value="{{ $pr04->tariff_code }}" readonly />
                @error('tariff_code')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="tariff_quantity" type="text"
                    ...
                    value="{{ $pr04->tariff_quantity }}" readonly />
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="price" type="text" class="form-control @error('price') is-invalid @enderror"
                    name="price" value="{{ $pr04->price }}" readonly />
                @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="surcharge_type" type="text" class="form-control @error('surcharge_type') is-invalid @enderror"
                    name="surcharge_type" value="{{ $pr04->surcharge_type }}" readonly />
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="surcharge" type="text" class="form-control @error('surcharge') is-invalid @enderror"
                    name="surcharge" value="{{ $pr04->surcharge }}" readonly />
                @error('surcharge')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
