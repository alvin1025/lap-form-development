...
@section('content')
    ...
    <form action="{{ route('kepemilikanKantor.update', ['kepemilikanKantor' => $kepemilikanKantor->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="kepemilikan_kantor" type="text"
                        ...
                        value="{{ $kepemilikanKantor->kepemilikan_kantor }}" />
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" value="{{ $kepemilikanKantor->description }}" />
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
