...
@section('content')
    ...
    <form action="{{ route('pr03.update', ['pr03' => $pr03->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="pricegrp" type="text" class="form-control @error('pricegrp') is-invalid @enderror"
                        name="pricegrp" value="{{ $pr03->pricegrp }}" />
                    @error('pricegrp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="currency" type="text" class="form-control @error('currency') is-invalid @enderror"
                        name="currency" value="{{ $pr03->currency }}" />
                    @error('currency')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="price_unit" type="text" class="form-control @error('price_unit') is-invalid @enderror"
                        name="price_unit" value="{{ $pr03->price_unit }}" />
                    @error('price_unit')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
