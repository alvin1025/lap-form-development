        ...
        <div class="d-flex justify-content-evenly">
            <div class="col-sm-6">
                <div class="d-flex flex-row mt-2">
                    ...
                    <div class="col-sm-6">
                        <input id="collecion" type="text" class="form-control @error('collecion') is-invalid @enderror"
                            name="collecion" value="{{ $va03->collecion }}" disabled />
                        @error('collecion')
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="col-sm-6">
                        <input id="description" type="text"
                            ...
                            value="{{ $va03->description }}" disabled />
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="d-flex flex-row mt-2">
                    ...
                    <div class="col-sm-6">
                        <input id="blocked_since" type="text"
                            ...
                            value="{{ $va03->blocked_since }}" disabled />
                        @error('blocked_since')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="d-flex justify-content-evenly">
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="col-sm-6">
                        <input id="period_from" type="date"
                            ...
                            value="{{ $va03->period_from }}" disabled />
                        @error('period_from')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
            ...
            <div class="col-sm-6">
                <div class="d-flex flex-row mt-2">
                    ...
                    <div class="col-sm-6">
                        <input id="period_to" type="date" class="form-control @error('period_to') is-invalid @enderror"
                            name="period_to" value="{{ $va03->period_to }}" disabled />
                        @error('period_to')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
