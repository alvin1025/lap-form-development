...
@section('content')
    ...
    <form action="{{ route('orientasiMarket.update', ['orientasiMarket' => $orientasiMarket->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="orientasi_market" type="text"
                        ...
                        value="{{ $orientasiMarket->orientasi_market }}" />
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" value="{{ $orientasiMarket->description }}" />
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
