...
@section('content')
    ...
    <div class="container">
            ...
            <div class="col-sm-6">
                <div class="d-flex flex-row">
                    <div class="col-sm-2 mr-5">
                        <label type="text" name="" id="" class="form-label" style="font-size: 13px">Dept
                            Name
            ...
            <div class="col-sm-6">
                <div class="d-flex flex-row mt-2">
                    <div class="col-sm-2 mr-3">
                        <label type="text" name="" id="" class="form-label" style="font-size: 13px">User
                            Group
        ...
        <div class="d-flex justify-content-evenly">
            <div class="col-sm-6">
                <div class="d-flex flex-row">
                    <div class="col-sm-2 mr-5">
                        <label type="text" name="" id="" class="form-label" style="font-size: 13px">Menu
                            Group
                ...
                <div class="d-flex flex-row mt-2">
                    ...
                    <div class="col-sm-8">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" value="{{ $keyacc->name }}" disabled />
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
    ...
    <div class="
        ...
        <div class="col-sm-1 mr-5">
            <a href="{{ route('keyacc.index') }}" class="btn btn-dangers">BACK</a>
        </div>
    </div>
    {{-- </form> --}}
