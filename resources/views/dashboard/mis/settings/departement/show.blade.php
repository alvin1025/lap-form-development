...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-center">
            <label class="col-sm-2 col-form-label my-2">Departement</label>
            <div class="col-sm-5 my-2">
                <input id="key" type="text" class="form-control @error('key') is-invalid @enderror" name="key"
                    value="{{ $departement->key }}" readonly />
                @error('key')
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-sm-5 my-2">
                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                    name="description" value="{{ $departement->description }}" readonly />
                @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
    ...
    <div class="
        ...
        <div class="col-sm-1 mr-5">
            <a href="{{ route('departement.index') }}" class="btn btn-danger">BACK</a>
        </div>
    </div>
    {{-- </form> --}}
