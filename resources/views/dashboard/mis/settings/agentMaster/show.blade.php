                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input id="name1" type="text" class="form-control @error('name1') is-invalid @enderror"
                                name="name1" value="{{ $agent->name1 }}" readonly />
                            @error('name1')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input id="name2" type="text" class="form-control @error('name2') is-invalid @enderror"
                                name="name2" value="{{ $agent->name2 }}" readonly />
                            @error('name2')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input id="street" type="text" class="form-control @error('street') is-invalid @enderror"
                                name="street" value="{{ $agent->street }}" readonly />
                            @error('street')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input id="addit" type="text" class="form-control @error('addit') is-invalid @enderror"
                                name="addit" value="{{ $agent->addit }}" readonly />
                            @error('addit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="shortname" type="text"
                                ...
                                value="{{ $agent->shortname }}" readonly />
                            @error('shortname')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-5">
                        ...
                        <div class="col-sm-8">
                            <input id="fax" type="text" class="form-control @error('fax') is-invalid @enderror"
                                name="fax" value="{{ $agent->fax }}" readonly />
                            @error('fax')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="cty" type="text" class="form-control @error('cty') is-invalid @enderror"
                                name="cty" value="{{ $agent->cty }}" readonly />
                            @error('cty')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
