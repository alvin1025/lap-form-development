...
@section('title', 'Form Payment Key')

@section('content')

    <form action="{{ route('paykind.update', ['paykind' => $payment->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
        ...
        <div class="container">
            <div class="d-flex justify-content-center">
                <label class="col-sm-2 col-form-label my-2">Payment Kind</label>
                <div class="col-sm-5 my-2">
                    <input id="key" type="text" class="form-control @error('key') is-invalid @enderror"
                        name="key" value="{{ $payment->key }}" />
                    @error('key')
