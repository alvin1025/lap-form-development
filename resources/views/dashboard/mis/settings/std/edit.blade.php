...
@section('content')
    ...
    <form action="{{ route('stdSample.update', ['stdSample' => $stdSample->id]) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="std_sample" type="text" class="form-control @error('std_sample') is-invalid @enderror"
                        name="std_sample" value="{{ $stdSample->std_sample }}" />
                    @error('std_sample')
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-sm-5 my-2">
                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" value="{{ $stdSample->description }}" />
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
