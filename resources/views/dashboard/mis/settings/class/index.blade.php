...
@section('content')
    ...
    <div class="table-responsive">
        <div class="d-flex justify-content-start">
            <a href="{{ route('classes.create') }}" class="btn btn-primary mb-3">Create New Form</a>
            ...
            <tbody>
                @foreach ($class as $form)
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/mis/settings/classes/{{ $form->id }}" class="badge bg-info"><i
                                    class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="/dashboard/mis/settings/classes/{{ $form->id }}/edit" class="badge bg-warning"><i
                                    class="fas fa-edit"></i></a>
                            <form action="/dashboard/mis/settings/classes/{{ $form->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
