...
@section('content')
    ...
    <form action="{{ route('qard.store') }}" method="post">
        @csrf
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control @error('f-method') is-invalid @enderror"
                                name="f-method" />
                            @error('f-method')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control @error('greige_tearing_lusi_3') is-invalid @enderror"
                                name="greige_tearing_lusi_3" id="greige_tearing_lusi_3" onkeyup="getAverage();" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input type="text"
                                ...
                                name="pfd_lebar_after_shrinkage" />
            ...
            <div class="d-flex justify-content-between mt-3">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_lusi_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_pakan_1_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_pakan_2_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_pakan_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_lusi_1_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_lusi_2_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_lusi_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_pakan_1_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_pakan_2_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_pakan_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_lusi_1_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_lusi_2_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_lusi_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_pakan_1_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_pakan_2_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_pakan_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Lebar After Shrinkage</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_lebar_after_shrinkage_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Stretch</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_stretch_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Pilling Resistance</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_pilling_resistance_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Construction</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_construction_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Width</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_width_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_weight_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_weight_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_lusi_1_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_lusi_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_lusi_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_pakan_1_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_pakan_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tensile_pakan_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_lusi_1_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_lusi_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_lusi_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_pakan_1_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_pakan_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_tearing_pakan_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_lusi_1_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_lusi_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_lusi_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_pakan_1_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_pakan_2_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_shrinkage_pakan_3_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Lebar After Shrinkage</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_lebar_after_shrinkage_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Stretch</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_stretch_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Pilling Resistance</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="pfd_pilling_resistance_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Construction</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_construction" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Width</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_width_finish" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_1" id="finish_weight_1"
                                onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_2" id="finish_weight_2"
                                onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_3" id="finish_weight_3"
                                onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_avg" id="finish_weight_avg"
                                onkeypress="average()" />
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_1"
                                id="finish_tensile_lusi_1" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_2"
                                id="finish_tensile_lusi_2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_3"
                                id="finish_tensile_lusi_3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_avg"
                                id="finish_tensile_lusi_avg" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_1"
                                id="finish_tensile_pakan_1" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_2"
                                id="finish_tensile_pakan_2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_3"
                                id="finish_tensile_pakan_3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_avg"
                                id="finish_tensile_pakan_avg" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_1"
                                id="finish_tearing_lusi_1" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_2"
                                id="finish_tearing_lusi_2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_3"
                                id="finish_tearing_lusi_3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_avg"
                                id="finish_tearing_lusi_avg" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_1"
                                id="finish_tearing_pakan_1" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_2"
                                id="finish_tearing_pakan_2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_3"
                                id="finish_tearing_pakan_3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_avg"
                                id="finish_tearing_pakan_avg" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_slippage" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_1"
                                id="finish_shringkage_lusi_1" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_2"
                                id="finish_shringkage_lusi_2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_3"
                                id="finish_shringkage_lusi_3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_avg"
                                id="finish_shringkage_lusi_avg" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_pakan_1" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_pakan_2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_pakan_3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Lebar After Shrinkage</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_lebar_after_shrinkage" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Stretch</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_stretch" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Pilling Resistance</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_pilling_resistance" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Construction</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_construction_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Width</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_width_finish_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_1_opt2" id="finish_weight_1_opt2"
                                onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_2_opt2" id="finish_weight_2_opt2"
                                onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_3_opt2" id="finish_weight_3_opt2"
                                onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_avg_opt2"
                                id="finish_weight_avg_opt2" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_1_opt2"
                                id="finish_tensile_lusi_1_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_2_opt2"
                                id="finish_tensile_lusi_2_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_3_opt2"
                                id="finish_tensile_lusi_3_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_avg_opt2"
                                id="finish_tensile_lusi_avg_opt2" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_1_opt2"
                                id="finish_tensile_pakan_1_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_2_opt2"
                                id="finish_tensile_pakan_2_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_3_opt2"
                                id="finish_tensile_pakan_3_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_pakan_avg_opt2"
                                id="finish_tensile_pakan_avg_opt2" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_1_opt2"
                                id="finish_tearing_lusi_1_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_2_opt2"
                                id="finish_tearing_lusi_2_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_3_opt2"
                                id="finish_tearing_lusi_3_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_lusi_avg_opt2"
                                id="finish_tearing_lusi_avg_opt2" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_1_opt2"
                                id="finish_tearing_pakan_1_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_2_opt2"
                                id="finish_tearing_pakan_2_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_3_opt2"
                                id="finish_tearing_pakan_3_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tearing_pakan_avg_opt2"
                                id="finish_tearing_pakan_avg_opt2" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-12">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Slippage</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_slippage_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_1_opt2"
                                id="finish_shringkage_lusi_1_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_2_opt2"
                                id="finish_shringkage_lusi_2_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_3_opt2"
                                id="finish_shringkage_lusi_3_opt2" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_lusi_avg_opt2"
                                id="finish_shringkage_lusi_avg_opt2" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_pakan_1_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_pakan_2_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_shringkage_pakan_3_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Lebar After Shrinkage</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_lebar_after_shrinkage_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Stretch</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_stretch_opt2" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Pilling Resistance</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_pilling_resistance_opt2" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Construction</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_construction_opt3" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Width</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_width_finish_opt3" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_1_opt3"
                                id="finish_weight_1_opt3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_2_opt3"
                                id="finish_weight_2_opt3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_3_opt3"
                                id="finish_weight_3_opt3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Rata-rata</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_weight_avg_opt3"
                                id="finish_weight_avg_opt3" onkeypress="average()" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">I</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_1_opt3"
                                id="finish_tensile_lusi_1_opt3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">II</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_2_opt3"
                                id="finish_tensile_lusi_2_opt3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">III</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="finish_tensile_lusi_3_opt3"
                                id="finish_tensile_lusi_3_opt3" onkeyup="getAverage();" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
