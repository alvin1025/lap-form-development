...
@section('title', 'Customer Data KD03')
                ...
                <div class="d-flex justify-content-start">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex flex-row mt-2">
                                <div class="col-sm-3">
                                    <label type="text" name="" id="" class="form-label" style="font-size: 13px">Postal
                                        Code</label>
                                </div>
                                <div class="col-sm-8">
                                    <input id="postal_code" type="number"
                                        class="form-control @error('postal_code') is-invalid @enderror" name="postal_code"
                                        value="{{ $kd03->postal_code }}" />
                                    @error('postal_code')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-8">
                                    <input id="text" type="text" class="form-control @error('po_box') is-invalid @enderror"
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <select class="selectpicker" aria-label="Default select example" name="kode_county"
                                        data-live-search="true">
                                        <option value="{{ $kd03->kode_county }}" selected>{{ $kd03->kode_county }}
                                        </option>
