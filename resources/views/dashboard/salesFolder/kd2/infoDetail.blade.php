                                                ...
                                                <div class="d-flex flex-row mt-2">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input id="mobile" type="text"
                                                            ...
                                                            style="{{ $kd03->mobile == null ? 'color:red' : '' }}"
                                                            disabled />
                                                        @error('mobile')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                        ...
                                                        <div class="d-flex flex-row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    style="{{ $kd05->title1 == null ? 'color:red' : '' }}"
                                                                    disabled>
                                                                @error('title1')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input id="npwp" type="text"
                                                        ...
                                                        style="{{ $kd06->nama_agent1 == null ? 'color:red' : '' }}"
                                                        disabled />
                                                    @error('nama_agent1')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                ...
                                                <div class="col-sm-4">
                                                    <input id="npwp" type="text"
                                                        ...
                                                        style="{{ $kd06->staff_member == null ? 'color:red' : '' }}"
                                                        disabled />
                                                    @error('staff_member')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input id="npwp" type="text"
                                                        ...
                                                        style="{{ $kd06->allowance_qty == null ? 'color:red' : '' }}"
                                                        disabled />
                                                    @error('allowance_qty')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                ...
                                                <div class="col-sm-3">
                                                    <input id="npwp" type="text"
                                                        ...
                                                        style="{{ $kd06->print == null ? 'color:red' : '' }}"
                                                        disabled />
                                                    @error('print')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                        ...
                                        <div class="d-flex flex-row mt-2">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="association1" type="text"
                                                    ...
                                                    style="{{ $kd11->association_no1 == null ? 'color:red' : '' }}"
                                                    disabled />
                                                @error('association1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="d-flex flex-row mt-2">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="sales" type="text"
                                                    ...
                                                    style="{{ $kd11->central_regu1 == null ? 'color:red' : '' }}"
                                                    disabled />
                                                @error('sales')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="d-flex flex-row mt-2">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="sales" type="text"
                                                    ...
                                                    style="{{ $kd11->conditions1 == null ? 'color:red' : '' }}"
                                                    disabled />
                                                @error('sales')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
