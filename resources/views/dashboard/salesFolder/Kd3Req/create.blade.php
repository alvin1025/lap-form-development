...
@section('content')
    ...
    @endif
    <form action="{{ route('kd03request.store') }}" method="POST">
        @csrf
        <h6 class="text-left mt-3">KD03 Request Master</h6>
        <hr>
        <div class="row">
            <div class="d-flex justify-content-start">
                <div class="row">
                                ...
                                <select class="selectpicker" aria-label="Default select example" name="class"
                                    ...
                                    @foreach ($classes as $class)
                                        @if (old('class') == $class->class)
                                            <option value="{{ $class->class }} / {{ $class->description }}" selected>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="postal_code" type="number"
                                    class="form-control @error('postal_code') is-invalid @enderror" name="postal_code" value="{{ old('postal_code') }}"/>
                                @error('postal_code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-5">
                                <input id="no_cust" type="text"
                                    class="form-control @error('no_cust') is-invalid @enderror" name="no_cust" readonly/>
                                @error('no_cust')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-5">
                            ...
                            <div class="col-sm-8">
                                <input id="fax" type="text"
                                    class="form-control @error('fax') is-invalid @enderror" name="fax"  value="{{ old('fax') }}"/>
                                @error('fax')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-3">
                                <a href="{{ route('kd03request.index') }}" class="btn btn-danger">BACK</a>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <select class="selectpicker" aria-label="Default select example" name="kode_county"
                                    ...
                                    @foreach ($kodeCountries as $country)
                                        @if (old('kode_county') == $country->kode_county)
                                            <option value="{{ $country->kode_county }} - {{ $country->description }}"
                                                selected>
