            ...
            <tr style="display: inline-block;">
                <td
                    ...
                    <h2 style="text-align: left;
							align-items: center;">
                        Request Perubahan data KD11 dengan nomor customer {{ $kd11['no_cust'] }} <br>
                        association {{ $kd11['nama'] }}
                    </h2>
                    <p>
                        <a href="/dashboard/salesFolder/kd5/new/{{ $kd11['no_cust'] }}/submit"
