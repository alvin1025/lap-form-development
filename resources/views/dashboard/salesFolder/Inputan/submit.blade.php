...
@section('content')
    ...
    <form action="{{ route('update.Kd03', ['id' => $kd03->id]) }}" method="post">
        @csrf
        @method('put')

        <div class="card">
            <div class="card-header text-center">
                Permintaan Input/Ubah Data Customer
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" value="{{ $kd03->nama1 ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" value="{{ $kd03->nama2 ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 12px">Additional
                                    Address</label>
                            </div>
                            <div class="col-sm-8">
                                <input id="addit" type="text" class="form-control @error('addit') is-invalid @enderror"
                                    name="addit" value="{{ $kd03->addit ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="kota" type="text" class="form-control @error('kota') is-invalid @enderror"
                                    name="kota" value="{{ $kd03->kota ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-row mt-4">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 12px">Postal
                                    Code</label>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ $kd03->email ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="fax" type="text" class="form-control @error('fax') is-invalid @enderror"
                                    name="fax" value="{{ $kd03->fax ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="telp" type="text" class="form-control @error('telp') is-invalid @enderror"
                                    name="telp" value="{{ $kd03->telp ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror"
                                    name="mobile" value="{{ $kd03->mobile ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="po_box" type="text" class="form-control @error('po_box') is-invalid @enderror"
                                    name="po_box" value="{{ $kd03->po_box ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                    name="npwp" value="{{ $kd03->npwp ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="col-sm-8">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label">No Creditor</label>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label">No Group Cust</label>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="col-sm-4">
                            <div class="d-flex flex-row mt-2">
                                <div class="col-sm-3 mr-5">
                                    <label type="text" name="" id="" class="form-label" style="font-size: 13px">Credit
                                        Limit</label>
                                </div>
                                <div class="col-sm-6">
                                    <input id="credit_limit" type="text"
                                        class="form-control @error('credit_limit') is-invalid @enderror"
                                        name="credit_limit" value="{{ $kd04->credit_limit ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="credit_limit" type="text"
                                class="form-control @error('credit_limit') is-invalid @enderror" name="credit_limit"
                                value="{{ $kd06->payterm ?? 'Data Belum Lengkap!' }}"
                                style="{{ $kd04->payterm == null ? 'color:red' : '' }}" disabled />
                            @error('payterm')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="credit_line_check" type="text"
                                    ...
                                    style="{{ $kd04->credit_line_check == null ? 'color:red' : '' }}" disabled />
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label" style="font-size: 12px">Block
                                    Delivery</label>
                            </div>
                            <div class="col-sm-6">
                                <input id="block_delivery" type="text"
                                    class="form-control @error('block_delivery') is-invalid @enderror"
                                    name="block_delivery" value="{{ $kd04->block_delivery ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="block" type="text" class="form-control @error('block') is-invalid @enderror"
                                    name="block" value="{{ $kd04->block ?? 'Data Belum Lengkap!' }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="nama" type="text"
                                                ...
                                                style="{{ $kd05->nama21 == null ? 'color:red' : '' }}" disabled />
                                            @error('nama')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="kode_cust" type="text"
                                                class="form-control @error('kode_cust') is-invalid @enderror"
                                                name="kode_cust" value="{{ $kd05->street1 ?? 'Data Belum Lengkap!' }}"
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="addit1" type="text"
                                                ...
                                                style="{{ $kd05->addit1 == null ? 'color:red' : '' }}" disabled />
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="mobile1" type="text"
                                                ...
                                                style="{{ $kd05->mobile1 == null ? 'color:red' : '' }}" disabled />
                                            @error('mobile1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="po_box1" type="text"
                                                ...
                                                style="{{ $kd05->po_box1 == null ? 'color:red' : '' }}" disabled />
                                            @error('po_box1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-6">
                                <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                    name="npwp" value="{{ $kd06->kd6nocust ?? 'Data Belum Lengkap!' }}"
                                    style="{{ $kd06->kd6nocust == null ? 'color:red' : '' }}" disabled />
                                @error('sd')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="col-sm-8">
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-sm-4">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->nama_agent1 ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-4">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->staff_member ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-3">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->from ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-3">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->to ?? 'Data Belum Lengkap!' }}"
                ...
                <div class="col-sm-8">
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-sm-3">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->allowance_qty ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-4">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->pc ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-3">
                            <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror"
                                name="npwp" value="{{ $kd06->print ?? 'Data Belum Lengkap!' }}"
                ...
                <div class="d-flex justify-content-around my-3">
                    <div class="col-sm-6">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-5">
                                <label type="text" name="" id="" class="form-label" style="font-size: 13px">Validity
                                    From</label>
                            </div>
                            <div class="col-sm-6">
                                <input id="sales" type="text" class="form-control @error('sales') is-invalid @enderror"
                                    name="sales" value="{{ $kd06->validity_from1 ?? 'Data Belum Lengkap!' }}"
                                    style="{{ $kd06->validity_from1 == null ? 'color:red' : '' }}" disabled />
                                @error('sales')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex flex-row mt-2">
                            <div class="col-sm-2 mr-3">
                                <label type="text" name="" id="" class="form-label">Validity To</label>
                            </div>
                            <div class="col-sm-6">
                                <input id="sales" type="text" class="form-control @error('sales') is-invalid @enderror"
                                    name="sales" value="{{ $kd06->validity_to1 ?? 'Data Belum Lengkap!' }}"
                                    style="{{ $kd06->validity_to1 == null ? 'color:red' : '' }}" disabled />
                                @error('sales')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="sales" type="text" class="form-control @error('sales') is-invalid @enderror"
                                ...
                                style="{{ $kd06->central_regu1 == null ? 'color:red' : '' }}" disabled />
                            @error('sales')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="sales" type="text" class="form-control @error('sales') is-invalid @enderror"
                                ...
                                style="{{ $kd06->conditions1 == null ? 'color:red' : '' }}" disabled />
                            @error('sales')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row text-center">
                        <div class="col-sm-3">
                            <input class="form-control @error('nama_cp1') is-invalid @enderror" type="text" id="nama_cp1"
                                name="nama_cp1" value="{{ $kd14->nama_cp1 ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-3">
                            <input class="form-control @error('sinc_cp1') is-invalid @enderror" type="text" id="sinc_cp1"
                                name="sinc_cp1" value="{{ $kd14->sinc_cp1 ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="d-flex flex-row text-center">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control @error('phone_cp1') is-invalid @enderror" type="text"
                                id="phone_cp1" name="phone_cp1" value="{{ $kd14->phone_cp1 ?? 'Data Belum Lengkap!' }}"
                        ...
                        <div class="col-sm-3">
                            <input class="form-control @error('email_cp1') is-invalid @enderror" type="email"
                                id="email_cp1" name="email_cp1" value="{{ $kd14->email_cp1 ?? 'Data Belum Lengkap!' }}"
                ...
                <div class="col-sm-8">
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="sales" type="text" class="form-control @error('sales') is-invalid @enderror"
                                name="sales" value="{{ $kd06->add_addr_cp1 ?? 'Data Belum Lengkap!' }}"
        ...
        @if (auth()->user()->division == 'FABRIC SALES' && auth()->user()->jabatan == 'Sub Division Manager')
            <input type="hidden" name="status_form" value="{{ $kd03->status_form }}">
            <input type="hidden" name="created_by" value="{{ $kd03->employee_name }}">

            {{-- <input type="hidden" name="submitted_by" value="{{ auth()->user()->employee_name }}"> --}}
        ...
        @elseif (auth()->user()->division == 'FABRIC SALES' && auth()->user()->jabatan == '' && $kd03->status_form == 'submitted')
            <div class="col-sm-8">
                <div class="d-flex flex-row mt-2">
                    <div class="col-sm-2 mr-3">
                        <label type="text" name="" id="" class="form-label">Status Form</label>
        ...
        @elseif (auth()->user()->division == 'FINANCE' && $kd03->status_form == 'aprv 1')
            <div class="col-sm-8">
                <div class="d-flex flex-row mt-2">
                    <div class="col-sm-2 mr-3">
                        <label type="text" name="" id="" class="form-label">Status Form</label>
        ...
        @elseif (auth()->user()->division == 'INTERNAL AUDIT' && auth()->user()->jabatan == 'Section Chief' && $kd03->status_form == 'aprv 2')
            <div class="col-sm-8">
                <div class="d-flex flex-row mt-2">
                    <div class="col-sm-2 mr-3">
                        <label type="text" name="" id="" class="form-label">Status Form</label>
        ...
        @elseif (auth()->user()->division == 'FABRIC SALES' && auth()->user()->jabatan == 'Section Chief' && $kd03->status_form == 'inputted')
            <div class="col-sm-8">
                <div class="d-flex flex-row mt-2">
                    <div class="col-sm-2 mr-3">
                        <label type="text" name="" id="" class="form-label">Status Form</label>
                    ...
                    <div class="card text-center w-100">
                        ...
                        <div class="card-body">
                            ...
                            @elseif ($kd03->submitted_by == '')
                                <label for="form-control text-center">{{ $kd03->rejectted_by }}</label>
                            @endif
                        </div>
        ...
        <div class="d-flex justify-content-end mb-5">
            <div class="col-sm-1">
                <a href="{{ route('outindex') }}" class="btn btn-danger">BACK</a>
            </div>
