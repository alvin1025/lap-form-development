    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-7 my-2">
                                <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                    name="tanggal" value="{{ $kd03->tanggal }}" disabled />
                                @error('tanggal')
                ...
                <h4 style="font-weight: bold;" class="text-center">Form Permintaan Input Cust Baru / Perubahan Data Cust
                </h4>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" value="{{ $kd03->title ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" value="{{ $kd03->class ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-8">
                            <input id="kode_cust" type="text" class="form-control @error('kode_cust') is-invalid @enderror"
                                name="kode_cust" value="{{ $kd03->kode_county ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="credit_line_check" type="text"
                                ...
                                name="credit_line_check" value="{{ $Kd04->credit_line_check ?? 'Data Belum Lengkap!' }}"
                ...
                <div class="col-sm-6">
                    <div class="d-flex flex-row mt-2">
                        <div class="col-sm-3 mr-2">
                            <label type="text" name="" id="" class="form-label" style="font-size: 12px">Block</label>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="d-flex flex-row text-center">
                    <div class="col-sm-3">
                        <input class="form-control @error('mobile_cp1') is-invalid @enderror" type="text" id="mobile_cp1"
                            name="mobile_cp1" value="{{ $kd14->mobile_cp1 ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="col-sm-3">
                        <input class="form-control @error('phone_cp1') is-invalid @enderror" type="text" id="phone_cp1"
                            name="phone_cp1" value="{{ $kd14->phone_cp1 ?? 'Data Belum Lengkap!' }}"
                    ...
                    <div class="col-sm-3">
                        <input class="form-control @error('email_cp1') is-invalid @enderror" type="email" id="email_cp1"
                            name="email_cp1" value="{{ $kd14->email_cp1 ?? 'Data Belum Lengkap!' }}"
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-8">
                                    <input id="kd5_nama2" type="text"
                                        ...
                                        value="{{ $customer->kd5_nama2 }}" disabled />
                                    @error('kd5_nama2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                <div class="col-sm-5">
                                    <input id="kd05_no_cust2" type="text"
                                        ...
                                        name="kd05_no_cust2" value="{{ $customer->kd05_no_cust2 }}" disabled />
                                    @error('kd05_no_cust2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <input id="kd05_kode_cust2" type="text"
                                        ...
                                        name="kd05_kode_cust2" value="{{ $customer->kd05_kode_cust2 }}" disabled />
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_kota2" type="text"
                                        ...
                                        value="{{ $customer->kd5_kota2 }}" disabled />
                                    @error('kd5_kota2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_email2" type="email"
                                        ...
                                        value="{{ $customer->kd5_email2 }}" disabled />
                                    @error('kd5_email2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_telp2" type="text"
                                        ...
                                        value="{{ $customer->kd5_telp2 }}" disabled />
                                    @error('kd5_telp2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_npwp2" type="text"
                                        ...
                                        value="{{ $customer->kd5_npwp2 }}" disabled />
                                    @error('kd5_npwp2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-8">
                                    <input id="kd5_nama3" type="text"
                                        ...
                                        value="{{ $customer->kd5_nama3 }}" disabled />
                                    @error('kd5_nama3')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                <div class="col-sm-5">
                                    <input id="kd5_no_cust3" type="text"
                                        ...
                                        name="kd5_no_cust3" value="{{ $customer->kd5_no_cust3 }}" disabled />
                                    @error('kd5_no_cust3')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_kode_cust3" type="text"
                                        ...
                                        name="kd5_kode_cust3" value="{{ $customer->kd5_kode_cust3 }}" disabled />
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_kota3" type="text"
                                        ...
                                        value="{{ $customer->kd5_kota3 }}" disabled />
                                    @error('kd5_kota3')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_email3" type="text"
                                        ...
                                        value="{{ $customer->kd5_email3 }}" disabled />
                                    @error('kd5_email3')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_telp3" type="text"
                                        ...
                                        value="{{ $customer->kd5_telp3 }}" disabled />
                                    @error('kd5_telp3')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="d-flex flex-row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <input id="kd5_npwp3" type="text"
                                        ...
                                        value="{{ $customer->kd5_npwp3 }}" disabled />
                                    @error('kd5_npwp3')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
