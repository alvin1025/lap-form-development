...
@section('content')
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-3">
                    <select class="selectpicker" aria-label="Default select example" name="kode_cust"
                        data-live-search="true" onchange="getValue();" id="kode_cust">
                        <option selected>Open this select menu</option>
                        @foreach ($credits as $credit)
                            @if (old('kode_cust') == $credit->kode_cust)
                                <option data-tokens="{{ $credit->kode_cust }}" data-price="{{ $$credit->kode_cust }}"
                                    selected>
                                    {{ $credit->kode_cust }}
                                </option>
                            @else
    ...
    <script>
        ...
        sel.addEventListener('click', function(e) {
            ...
            document.getElementById('kode_cust').value = price;
        });
        ...
        // let sel = document.getElementById('kode_cust');
        // sel.addEventListener('click', function(e) {
        //     let no_cust = e.srcElement.selectedOptions['0'].dataset.no_cust;
        //     document.getElementById('no_cust').value = no_cust;
        // })
    </script>
@endsection
