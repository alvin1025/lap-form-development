        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-3">
                <input id="kode_cust" type="text" class="form-control @error('kode_cust') is-invalid @enderror"
                    name="kode_cust" value="{{ $credit->kode_cust }}" readonly />
                @error('kode_cust')
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="nama_cust" type="text" class="form-control @error('nama_cust') is-invalid @enderror"
                    name="nama_cust" value="{{ $credit->nama_cust }}" readonly />
                @error('nama_cust')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="contact_person" type="text" class="form-control @error('contact_person') is-invalid @enderror"
                    name="contact_person" value="{{ $credit->contact_person }}" readonly />
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-3">
                <input id="lama_bisnis" type="text" class="form-control @error('lama_bisnis') is-invalid @enderror"
                    name="lama_bisnis" value="{{ $credit->lama_bisnis }}" readonly />
                @error('lama_bisnis')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-1">
                <input id="lama_bekerja_dengan_lpa" type="text"
                    ...
                    name="lama_bekerja_dengan_lpa" value="{{ $credit->lama_bekerja_dengan_lpa }}" readonly />
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-3">
                <input id="bank_koresponden1" type="text"
                    ...
                    value="{{ $credit->bank_koresponden1 }}" readonly />
            ...
            <div class="col-sm-3">
                <input id="bank_koresponden2" type="text"
                    ...
                    value="{{ $credit->bank_koresponden2 }}" readonly />
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_cust1" type="text" class="form-control @error('data_cust1') is-invalid @enderror"
                    name="data_cust1" value="{{ $credit->data_cust1 }}" readonly />
                @error('data_cust1')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-1">
            ...
            <div class="col-sm-6">
                <input id="data_cust2" type="text" class="form-control @error('data_cust2') is-invalid @enderror"
                    name="data_cust2" value="{{ $credit->data_cust2 }}" readonly />
                @error('data_cust2')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_cust3" type="text" class="form-control @error('data_cust3') is-invalid @enderror"
                    name="data_cust3" value="{{ $credit->data_cust3 }}" readonly />
                @error('data_cust3')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_cust4" type="text" class="form-control @error('data_cust4') is-invalid @enderror"
                    name="data_cust4" value="{{ $credit->data_cust4 }}" readonly />
                @error('data_cust4')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_cust5" type="text" class="form-control @error('data_cust5') is-invalid @enderror"
                    name="data_cust5" value="{{ $credit->data_cust5 }}" readonly />
                @error('data_cust5')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_supp1" type="text" class="form-control @error('data_supp1') is-invalid @enderror"
                    name="data_supp1" value="{{ $credit->data_supp1 }}" readonly />
                @error('data_supp1')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-1">
            ...
            <div class="col-sm-6">
                <input id="data_supp2" type="text" class="form-control @error('data_supp2') is-invalid @enderror"
                    name="data_supp2" value="{{ $credit->data_supp2 }}" readonly />
                @error('data_supp2')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_supp3" type="text" class="form-control @error('data_supp3') is-invalid @enderror"
                    name="data_supp3" value="{{ $credit->data_supp3 }}" readonly />
                @error('data_supp3')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_supp4" type="text" class="form-control @error('data_supp4') is-invalid @enderror"
                    name="data_supp4" value="{{ $credit->data_supp4 }}" readonly />
                @error('data_supp4')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="data_supp5" type="text" class="form-control @error('data_supp5') is-invalid @enderror"
                    name="data_supp5" value="{{ $credit->data_supp5 }}" readonly />
                @error('data_supp5')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="alasan_perubahan" type="text"
                    ...
                    value="{{ $credit->alasan_perubahan }}" readonly />
        ...
        <div class="d-flex flex-row mt-2">
            ...
            <div class="col-sm-6">
                <input id="history_pembayaran" type="text"
                    ...
                    value="{{ $credit->history_pembayaran }}" readonly />
