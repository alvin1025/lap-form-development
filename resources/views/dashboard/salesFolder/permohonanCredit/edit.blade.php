...
@section('content')
    ...
    <form action="{{ route('credit.update', ['credit' => $credit->id]) }}" method="post">
        @csrf
        @method('put')
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-3">
                    <input id="kode_cust" type="text" class="form-control @error('kode_cust') is-invalid @enderror"
                        name="kode_cust" value="{{ $credit->kode_cust }}" />
                    @error('kode_cust')
                ...
                <div class="col-sm-3">
                    <input id="no_cust" type="text" class="form-control @error('no_cust') is-invalid @enderror"
                        name="no_cust" value="{{ $credit->no_cust }}" />
                    @error('no_cust')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="nama_cust" type="text" class="form-control @error('nama_cust') is-invalid @enderror"
                        name="nama_cust" value="{{ $credit->nama_cust }}" />
                    @error('nama_cust')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-3">
                    <input id="no_telp" type="text" class="form-control @error('no_telp') is-invalid @enderror"
                        name="no_telp" value="{{ $credit->no_telp }}" />
                    @error('no_telp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-3">
                    <input id="lama_bisnis" type="text" class="form-control @error('lama_bisnis') is-invalid @enderror"
                        name="lama_bisnis" value="{{ $credit->lama_bisnis }}" />
                    @error('lama_bisnis')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-1">
                    <input id="lama_bekerja_dengan_lpa" type="text"
                        ...
                        name="lama_bekerja_dengan_lpa" value="{{ $credit->lama_bekerja_dengan_lpa }}" />
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-3">
                    <input id="bank_koresponden1" type="text"
                        ...
                        value="{{ $credit->bank_koresponden1 }}" />
                ...
                <div class="col-sm-3">
                    <input id="bank_koresponden2" type="text"
                        ...
                        value="{{ $credit->bank_koresponden2 }}" />
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_cust1" type="text" class="form-control @error('data_cust1') is-invalid @enderror"
                        name="data_cust1" value="{{ $credit->data_cust1 }}" />
                    @error('data_cust1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-1">
                ...
                <div class="col-sm-6">
                    <input id="data_cust2" type="text" class="form-control @error('data_cust2') is-invalid @enderror"
                        name="data_cust2" value="{{ $credit->data_cust2 }}" />
                    @error('data_cust2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_cust3" type="text" class="form-control @error('data_cust3') is-invalid @enderror"
                        name="data_cust3" value="{{ $credit->data_cust3 }}" />
                    @error('data_cust3')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_cust4" type="text" class="form-control @error('data_cust4') is-invalid @enderror"
                        name="data_cust4" value="{{ $credit->data_cust4 }}" />
                    @error('data_cust4')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_cust5" type="text" class="form-control @error('data_cust5') is-invalid @enderror"
                        name="data_cust5" value="{{ $credit->data_cust5 }}" />
                    @error('data_cust5')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_supp1" type="text" class="form-control @error('data_supp1') is-invalid @enderror"
                        name="data_supp1" value="{{ $credit->data_supp1 }}" />
                    @error('data_supp1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-1">
                ...
                <div class="col-sm-6">
                    <input id="data_supp2" type="text" class="form-control @error('data_supp2') is-invalid @enderror"
                        name="data_supp2" value="{{ $credit->data_supp2 }}" />
                    @error('data_supp2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_supp3" type="text" class="form-control @error('data_supp3') is-invalid @enderror"
                        name="data_supp3" value="{{ $credit->data_supp3 }}" />
                    @error('data_supp3')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_supp4" type="text" class="form-control @error('data_supp4') is-invalid @enderror"
                        name="data_supp4" value="{{ $credit->data_supp4 }}" />
                    @error('data_supp4')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="data_supp5" type="text" class="form-control @error('data_supp5') is-invalid @enderror"
                        name="data_supp5" value="{{ $credit->data_supp5 }}" />
                    @error('data_supp5')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-6">
                    <input id="history_pembayaran" type="text"
                        ...
                        value="{{ $credit->history_pembayaran }}" />
            ...
            <div class="d-flex flex-row mt-2">
                ...
                <div class="col-sm-4">
                    <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                        name="tanggal" value="{{ $credit->tanggal }}" />
                    @error('tanggal')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
