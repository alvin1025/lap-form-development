                        ...
                        <div class="d-flex flex-row my-2">
                            <div class="col-sm-5">
                                <input id="no_cust1" type="text"
                                    ...
                                    value="{{ $kd05->no_cust1 }}"
                                    style="{{ $kd05->no_cust1 == null ? 'color:black' : '' }}" disabled />
                                @error('no_cust1')
                            ...
                            <div class="col-sm-6">
                                <input id="kode_cust" type="text"
                                    ...
                                    style="{{ $kd05->addresscode1 == null ? 'color:black' : '' }}" disabled />
                                @error('kode_cust')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control"
                                    value="{{ $kd05->title1 ?? '-' }}"
                                    style="{{ $kd05->title1 == null ? 'color:black' : '' }}" disabled>
                                @error('title1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="nama" type="text"
                                    ...
                                    value="{{ $kd05->nama11 ?? '-' }}"
                                    style="{{ $kd05->nama11 == null ? 'color:black' : '' }}" disabled />
                                @error('nama')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="nama" type="text"
                                    class="form-control @error('nama') is-invalid @enderror" name="nama"
                                    value="{{ $kd05->nama21 ?? '-' }}"
                                    style="{{ $kd05->nama21 == null ? 'color:black' : '' }}" disabled />
                                @error('nama')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="kode_cust" type="text"
                                    class="form-control @error('kode_cust') is-invalid @enderror" name="kode_cust"
                                    value="{{ $kd05->street1 ?? '-' }}"
                                    style="{{ $kd05->street1 == null ? 'color:black' : '' }}" disabled />
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="addit1" type="text"
                                    ...
                                    value="{{ $kd05->addit1 ?? '-' }}"
                                    style="{{ $kd05->addit1 == null ? 'color:black' : '' }}" disabled />
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="kode_cust" type="text"
                                    ...
                                    style="{{ $kd05->kd5negara1 == null ? 'color:black' : '' }}" disabled />
                                @error('kd5negara1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="kode_cust" type="text"
                                    ...
                                    style="{{ $kd05->kode_county1 == null ? 'color:black' : '' }}" disabled />
                                @error('kode_country')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="kota" type="text"
                                    ...
                                    value="{{ $kd05->kota1 ?? '-' }}"
                                    style="{{ $kd05->kota1 == null ? 'color:black' : '' }}" disabled />
                                @error('kota')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-4">
                            ...
                            <div class="col-sm-8">
                                <input id="postal_code1" type="postal_code1"
                                    ...
                                    style="{{ $kd05->postal_code1 == null ? 'color:black' : '' }}" disabled />
                                @error('postal_code1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="email" type="email"
                                    ...
                                    value="{{ $kd05->email1 ?? '-' }}"
                                    style="{{ $kd05->email1 == null ? 'color:black' : '' }}" disabled />
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="fax1" type="text"
                                    ...
                                    value="{{ $kd05->fax1 ?? '-' }}"
                                    style="{{ $kd05->fax1 == null ? 'color:black' : '' }}" disabled />
                                @error('fax1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="telp1" type="text"
                                    ...
                                    value="{{ $kd05->telp1 ?? '-' }}"
                                    style="{{ $kd05->telp1 == null ? 'color:black' : '' }}" disabled />
                                @error('telp1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="mobile1" type="text"
                                    ...
                                    value="{{ $kd05->mobile1 ?? '-' }}"
                                    style="{{ $kd05->mobile1 == null ? 'color:black' : '' }}" disabled />
                                @error('mobile1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="po_box1" type="text"
                                    ...
                                    value="{{ $kd05->po_box1 ?? '-' }}"
                                    style="{{ $kd05->po_box1 == null ? 'color:black' : '' }}" disabled />
                                @error('po_box1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="col-sm-8">
                                <input id="npwp1" type="text"
                                    ...
                                    value="{{ $kd05->npwp1 ?? '-' }}"
                                    style="{{ $kd05->npwp1 == null ? 'color:black' : '' }}" disabled />
                                @error('npwp1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
