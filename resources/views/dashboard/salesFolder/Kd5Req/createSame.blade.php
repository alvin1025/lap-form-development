...
@section('content')
    ...
    @endif
    <form action="{{ route('kd05request.store') }}" method="POST">
        @csrf
                        ...
                        <div class="d-flex justify-content-start">
                            <div class="row">
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="nama11" type="text"
                                                class="form-control @error('nama11') is-invalid @enderror" name="nama11" value="{{ old('nama11') }}"/>
                                            @error('nama11')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="nama21" type="text"
                                                class="form-control @error('nama21') is-invalid @enderror" name="nama21" value="{{ old('nama21') }}"/>
                                            @error('nama21')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="addit1" type="text"
                                                class="form-control @error('addit1') is-invalid @enderror" name="addit1" value="{{ old('addit1') }}"/>
                                            @error('addit1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="postal_code1" type="number"
                                                ...
                                                name="postal_code1" value="{{ old('postal_code1') }}"/>
                                            @error('postal_code1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        <div class="col-sm-5">
                                            <input id="no_cust1" type="text"
                                                ...
                                                name="no_cust1" value="{{ $no_cust1 }}" readonly/>
                                            @error('no_cust1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <input id="addresscode1" type="text"
                                                ...
                                                name="addresscode1" value="{{ old('addresscode1') }}"/>
                                            @error('addresscode1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-5">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="fax1" type="text"
                                                class="form-control @error('fax1') is-invalid @enderror" name="fax1" value="{{ old('fax1') }}"/>
                                            @error('fax1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="po_box1" type="text"
                                                ...
                                                name="po_box1" value="{{ old('po_box1') }}"/>
                                            @error('po_box1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row mt-2">
                                        <div class="col-sm-3">
                                            <a href="{{ route('kd5.index') }}" class="btn btn-danger">BACK</a>
                                        </div>
                                        <div class="col-sm-3">
