                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 my-2">
                            <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                name="tanggal" value="{{ $customer->tanggal }}" />
                            @error('tanggal')
            ...
            <div class="tab-pane fade show active" id="kd03" role="tabpanel" aria-labelledby="kd03-tab">
                            ...
                            <select class="selectpicker" aria-label="Default select example" name="class"
                                ...
                                @foreach ($classes as $class)
                                    @if (old('class') == $class->class)
                                        <option data-tokens="{{ $class->class }}" selected>{{ $class->class }}
                                        </option>
                                    @else
                                        <option data-tokens="{{ $class->class }}">{{ $class->class }}</option>
                                    @endif
                                @endforeach
                            </select>
                            @error('class')
                    ...
                    <div class="d-flex flex-row mt-2">
                        <div class="col-sm-5">
                            <input id="no_cust" type="text" class="form-control @error('no_cust') is-invalid @enderror"
                                name="no_cust" value="{{ $customer->no_cust }}" />
                            @error('no_cust')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-sm-6">
                            <input id="kode_cust" type="text" class="form-control @error('kode_cust') is-invalid @enderror"
                                name="kode_cust" value="{{ $customer->kode_cust }}" />
                            @error('kode_cust')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-sm-8">
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <select class="selectpicker" aria-label="Default select example" name="kode_country"
                                data-live-search="true">
                                <option selected>Open this select menu</option>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="sales" type="text" class="form-control @error('sales') is-invalid @enderror"
                                name="sales" value="{{ $customer->sales }}" />
                            @error('sales')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="alasan_perubahan" type="text"
                                ...
                                name="alasan_perubahan" value="{{ $customer->alasan_perubahan }}" />
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <input id="history_pembayaran" type="text"
                                ...
                                name="history_pembayaran" value="{{ $customer->history_pembayaran }}" />
                                ...
                                <div class="d-flex flex-row mt-2">
                                    <div class="col-sm-5">
                                        <input id="kd5_no_cust1" type="text"
                                            ...
                                            name="kd5_no_cust1" value="{{ $customer->kd5_no_cust1 }}" />
                                        @error('kd5_no_cust1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input id="kd5_kode_cust1" type="text"
                                            ...
                                            name="kd5_kode_cust1" value="{{ $customer->kd5_kode_cust1 }}" />
                                ...
                                <div class="d-flex flex-row mt-2">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="kd5_email1" type="email"
                                            ...
                                            name="kd5_email1" value="{{ $customer->kd5_email1 }}" />
                                        @error('kd5_email1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="d-flex flex-row mt-2">
                                    <div class="col-sm-5">
                                        <input id="kd05_no_cust2" type="text"
                                            ...
                                            name="kd05_no_cust2" value="{{ $customer->kd05_no_cust2 }}" />
                                        @error('kd05_no_cust2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input id="kd05_kode_cust2" type="text"
                                            ...
                                            name="kd05_kode_cust2" value="{{ $customer->kd05_kode_cust2 }}" />
                                ...
                                <div class="d-flex flex-row mt-2">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="kd5_email2" type="email"
                                            ...
                                            name="kd5_email2" value="{{ $customer->kd5_email2 }}" />
                                        @error('kd5_email2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="d-flex flex-row mt-2">
                                    <div class="col-sm-5">
                                        <input id="kd5_no_cust3" type="text"
                                            ...
                                            name="kd5_no_cust3" value="{{ $customer->kd5_no_cust3 }}" />
                                        @error('kd5_no_cust3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input id="kd5_kode_cust3" type="text"
                                            ...
                                            name="kd5_kode_cust3" value="{{ $customer->kd5_kode_cust3 }}" />
                                ...
                                <div class="d-flex flex-row mt-2">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="kd5_email3" type="text"
                                            ...
                                            name="kd5_email3" value="{{ $customer->kd5_email3 }}" />
                                        @error('kd5_email3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
