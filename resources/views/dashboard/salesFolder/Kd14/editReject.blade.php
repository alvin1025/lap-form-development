...
@section('content')
    ...
    @endif
    <form action="{{ route('kd14.update', ['kd14' => $kd14->id]) }}" method="POST">
        @csrf
        @method('put')
                ...
                <div class="d-flex flex-row mt-2">
                    ...
                    <div class="col-sm-3">
                        <input id="cp1" type="text" class="form-control @error('cp1') is-invalid @enderror"
                            name="cp1" value="{{ old('cp1', $kd14->cp1) }}" oninput="getVal();" readonly/>
                        @error('cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="d-flex flex-row text-center">
                    <div class="col-sm-3">
                        <input class="form-control @error('nama_cp1') is-invalid @enderror" type="text" id="nama_cp1"
                            name="nama_cp1" value="{{ old('nama_cp1', $kd14->nama_cp1) }}">
                        @error('nama_cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-3">
                        <input class="form-control @error('function_cp1') is-invalid @enderror" type="text"
                            id="function_cp1" name="function_cp1" value="{{ old('function_cp1', $kd14->function_cp1) }}">
                        @error('function_cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-3">
                        <input class="form-control @error('sinc_cp1') is-invalid @enderror" type="date" id="sinc_cp1"
                            name="sinc_cp1" value="{{ old('sinc_cp1', $kd14->sinc_cp1) }}">
                        @error('sinc_cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="d-flex flex-row text-center">
                    <div class="col-sm-3">
                        <input class="form-control @error('mobile_cp1') is-invalid @enderror" type="number" id="mobile_cp1"
                            name="mobile_cp1" value="{{ old('mobile_cp1', $kd14->mobile_cp1) }}">
                        @error('mobile_cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-3">
                        <input class="form-control @error('phone_cp1') is-invalid @enderror" type="number"
                            id="phone_cp1" name="phone_cp1" value="{{ old('phone_cp1', $kd14->phone_cp1) }}">
                        @error('phone_cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-3">
                        <input class="form-control @error('email_cp1') is-invalid @enderror" type="email"
                            id="email_cp1" name="email_cp1" value="{{ old('email_cp1', $kd14->email_cp1) }}">
                        @error('email_cp1')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-sm-6">
                            <select class="selectpicker" aria-label="Default select example" name="add_addr_cp1"
                                data-live-search="true" data-container="body">
                                <option value="{{ $kd14->add_addr_cp1 }}" selected>{{ $kd14->add_addr_cp1 }}</option>
                                @foreach ($kd05 as $kd5)
                                    @if ($kd14->add_addr_cp1 == $kd5->addresscode1)
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <select class="selectpicker" aria-label="Default select example" name="status"
                                ...
                                <option value="1" {{ $kd14->status == 1 ? 'selected' : '' }}>Active
                                </option>
                                <option value="2" {{ $kd14->status == 2 ? 'selected' : '' }}>Inactive
                                </option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">
