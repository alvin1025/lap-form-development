...
@section('content')
    ...
    <form action="{{ route('kd6.store') }}" method="POST">
                    ...
                    <div class="d-flex flex-row mt-2">
                        ...
                        <div class="col-sm-6">
                            <select class="selectpicker" aria-label="Default select example" name="payterm"
                                data-live-search="true">
                                <option selected value="">Choose Payterm</option>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="col-sm-4">
                        <select class="selectpicker" aria-label="Default select example" name="nama_agent1"
                            id="agent" data-live-search="true">
        ...
        <a href="{{ route('getAllow', 'percobaan') }}">klik</a>
    </form>
    ...
    {{-- <script>
        $(document).ready(function() {
            $("#agent").change(function() {
                var allow = $(this).children(':selected').data('allow');
                console.log(allow);

                $("#allowance_qty").val(allow);
            });
        })
    </script> --}}
