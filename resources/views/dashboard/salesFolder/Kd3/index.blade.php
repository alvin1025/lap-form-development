                                ...
                                @foreach ($kd03 as $form)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- @if ((Auth::user()->division == 'FINANCE' && $form->status_form != 'inputted') || (Auth::user()->division == 'FABRIC SALES' && $form->status_form != 'inputted') || Auth::user()->division == 'MANAGEMENT INFORMATION SYSTEM')
