...
@section('title', 'Need Submit DM Finance')
                                ...
                                @foreach ($kd03 as $form)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            {{-- @if ((auth()->user()->division == 'FINANCE' && auth()->user()->jabatan == 'Division Manager' && $form->status_form == 'acknowledged'))
                                            <a href="/dashboard/salesFolder/kd2/new/kd4/{{ $form->no_cust }}"
                                                class="badge bg-success">Modify KD04</a>
                                            <a href="/dashboard/salesFolder/kd2/new/kd6/{{ $form->no_cust }}"
                                                class="badge bg-success">Modify KD06</a>
                                            @endif --}}
