...
@section('content')
    ...
    <form action="{{ route('perintah.update', ['perintah' => $perintah->id]) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 my-2">
                            <input id="no_surat" type="text" class="form-control @error('no_surat') is-invalid @enderror"
                                name="no_surat" value="{{ $perintah->no_surat }}" />
                            @error('no_surat')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror"
                            name="jabatan" value="{{ $perintah->jabatan }}" />
                        @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="perkerjaan" type="text" class="form-control @error('perkerjaan') is-invalid @enderror"
                            name="perkerjaan" value="{{ $perintah->perkerjaan }}" />
                        @error('perkerjaan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no1" value="{{ $perintah->no1 }}">
            </div>
            <div class="col-sm-4 text-center">
            ...
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume1" value="{{ $perintah->volume1 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no2" value="{{ $perintah->no2 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan2"
                    value="{{ $perintah->jenis_pekerjaan2 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume2" value="{{ $perintah->volume2 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no3" value="{{ $perintah->no3 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan3"
                    value="{{ $perintah->jenis_pekerjaan3 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume3" value="{{ $perintah->volume3 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no4" value="{{ $perintah->no4 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan4"
                    value="{{ $perintah->jenis_pekerjaan4 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume4" value="{{ $perintah->volume4 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no5" value="{{ $perintah->no5 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan5"
                    value="{{ $perintah->jenis_pekerjaan5 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume5" value="{{ $perintah->volume5 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no6" value="{{ $perintah->no6 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan6"
                    value="{{ $perintah->jenis_pekerjaan6 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume6" value="{{ $perintah->volume6 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no7" value="{{ $perintah->no7 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan7"
                    value="{{ $perintah->jenis_pekerjaan7 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume7" value="{{ $perintah->volume7 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no8" value="{{ $perintah->no8 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan8"
                    value="{{ $perintah->jenis_pekerjaan8 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume8" value="{{ $perintah->volume8 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no9" value="{{ $perintah->no9 }}">
            </div>
            <div class="col-sm-4 text-center">
                <input type="text" id="" class="form-control" name="jenis_pekerjaan9"
                    value="{{ $perintah->jenis_pekerjaan9 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="volume9" value="{{ $perintah->volume9 }}">
            </div>
            <div class="col-sm-2 text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 my-2">
                        <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                            name="tanggal" value="{{ $perintah->tanggal }}" />
                        @error('tanggal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
