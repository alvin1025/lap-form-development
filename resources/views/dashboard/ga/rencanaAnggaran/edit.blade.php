...
@section('content')
    ...
    <form action="{{ route('anggaran.update', ['anggaran' => $anggaran->id]) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                            name="tanggal" value="{{ $anggaran->tanggal }}" />
                        @error('tanggal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no1" value="{{ $anggaran->no1 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian1" id="uraian1" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya1" value="{{ $anggaran->biaya1 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no2" value="{{ $anggaran->no2 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian2" id="uraian2" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya2" value="{{ $anggaran->biaya2 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no3" value="{{ $anggaran->no3 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian3" id="uraian3" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya3" value="{{ $anggaran->biaya3 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no4" value="{{ $anggaran->no4 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian4" id="uraian4" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya4" value="{{ $anggaran->biaya4 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no5" value="{{ $anggaran->no5 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian5" id="uraian5" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya5" value="{{ $anggaran->biaya5 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no6" value="{{ $anggaran->no6 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian6" id="uraian6" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya6" value="{{ $anggaran->biaya6 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no7" value="{{ $anggaran->no7 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian7" id="uraian7" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya7" value="{{ $anggaran->biaya7 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no8" value="{{ $anggaran->no8 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian8" id="uraian8" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya8" value="{{ $anggaran->biaya8 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no9" value="{{ $anggaran->no9 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian9" id="uraian9" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya9" value="{{ $anggaran->biaya9 }}">
            </div>
            <div class="col-sm-4 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no10" value="{{ $anggaran->no10 }}">
            </div>
            <div class="col-sm-4 text-center">
                <textarea name="uraian10" id="uraian10" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="biaya10" value="{{ $anggaran->biaya10 }}">
            </div>
            <div class="col-sm-4 text-center">
