        ...
        <div class="d-flex justify-content-start">
            <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 ">
                        <input id="nrp" type="text" class="form-control @error('nrp') is-invalid @enderror my-2"
                            name="nrp" />
                        @error('nrp')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 ">
                        <input id="nik" type="text" class="form-control @error('nik') is-invalid @enderror my-2"
                            name="nik" />
                        @error('nik')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 ">
                        <input id="jam" type="text" class="form-control @error('jam') is-invalid @enderror my-2"
                            name="jam" />
                        @error('jam')
                            <div class="invalid-feedback">
                                {{ $message }}
