...
@section('content')
    ...
    <form action="{{ route('kebutuhan.update', ['kebutuhan' => $kebutuhan->id]) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 my-2">
                        <input id="no_kebutuhan_1" type="text"
                            ...
                            value="{{ $kebutuhan->no_kebutuhan_1 }}" />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                            name="tanggal" value="{{ $kebutuhan->tanggal }}" />
                        @error('tanggal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 ">
                        <input id="no_kebutuhan_2" type="text"
                            ...
                            value="{{ $kebutuhan->no_kebutuhan_2 }}" />
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no1" value="{{ $kebutuhan->no1 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian1" id="uraian1" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt1" value="{{ $kebutuhan->qtt1 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga1" value="{{ $kebutuhan->harga1 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no2" value="{{ $kebutuhan->no2 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian2" id="uraian2" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt2" value="{{ $kebutuhan->qtt2 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga2" value="{{ $kebutuhan->harga2 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no3" value="{{ $kebutuhan->no3 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian3" id="uraian3" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt3" value="{{ $kebutuhan->qtt3 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga3" value="{{ $kebutuhan->harga3 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no4" value="{{ $kebutuhan->no4 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian4" id="uraian4" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt4" value="{{ $kebutuhan->qtt4 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga4" value="{{ $kebutuhan->harga4 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no5" value="{{ $kebutuhan->no5 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian5" id="uraian5" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt5" value="{{ $kebutuhan->qtt5 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga5" value="{{ $kebutuhan->harga5 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no6" value="{{ $kebutuhan->no6 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian6" id="uraian6" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt6" value="{{ $kebutuhan->qtt6 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga6" value="{{ $kebutuhan->harga6 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no7" value="{{ $kebutuhan->no7 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian7" id="uraian7" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt7" value="{{ $kebutuhan->qtt7 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga7" value="{{ $kebutuhan->harga7 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no8" value="{{ $kebutuhan->no8 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian8" id="uraian8" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt8" value="{{ $kebutuhan->qtt8 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga8" value="{{ $kebutuhan->harga8 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no9" value="{{ $kebutuhan->no9 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian9" id="uraian9" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt9" value="{{ $kebutuhan->qtt9 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga9" value="{{ $kebutuhan->harga9 }}">
            </div>
            <div class="col-sm-2 text-center">
        ...
        <div class="d-flex flex-row">
            <div class="col-sm-1 text-center">
                <input type="text" id="" class="form-control" name="no10" value="{{ $kebutuhan->no10 }}">
            </div>
            <div class="col-sm-2 text-center">
                <textarea name="uraian10" id="uraian10" cols="30" rows="5" class="form-control"></textarea>
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="qtt10" value="{{ $kebutuhan->qtt10 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="harga10" value="{{ $kebutuhan->harga10 }}">
            </div>
            <div class="col-sm-2 text-center">
                <input type="text" id="" class="form-control" name="ttl_harga10"
                    value="{{ $kebutuhan->ttl_harga10 }}">
            </div>
            <div class="col-sm-2 text-center">
