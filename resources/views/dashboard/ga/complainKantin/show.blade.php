...
@section('content')
    ...
    {{-- <form action="{{ route('complain.update', ['complain' => $complain->id]) }}" method="post">
    @csrf
    @method('put') --}}
    ...
    <div class="row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7 my-2">
                        <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                            name="tanggal" value="{{ $complain->tanggal }}" readonly />
                        @error('tanggal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row"> <label class="col-sm-3 col-form-label my-2">Bagian / Divisi</label>
                    <div class="col-sm-7 my-2">
                        <input id="divisi" type="text" class="form-control @error('divisi') is-invalid @enderror"
                            name="divisi" value="{{ $complain->divisi }}" readonly />
                        @error('divisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="d-flex flex-row">
            ...
            <div class="col-sm-2 text-center">
                <div class="form-check ml-2">
                    <input class="form-check-input" type="checkbox" value="Baik" id="variasi_makanan" name="variasi_makanan"
                        readonly>
                </div>
            </div>
        </div>
        <div class="d-flex flex-row">
            ...
            <div class="col-sm-2 text-center">
                <div class="form-check ml-2">
                    <input class="form-check-input" type="checkbox" value="Buruk" id="pelayanan" name="pelayanan" readonly>
                </div>
            </div>
            <div class="col-sm-2 text-center">
                <div class="form-check ml-2">
                    <input class="form-check-input" type="checkbox" value="Biasa" id="pelayanan" name="pelayanan" readonly>
                </div>
            </div>
            <div class="col-sm-2 text-center">
                <div class="form-check ml-2">
                    <input class="form-check-input" type="checkbox" value="Baik" id="pelayanan" name="pelayanan" readonly>
                </div>
            </div>
        </div>
        <div class="d-flex flex-row">
            ...
            <div class="col-sm-2 text-center">
                <div class="form-check ml-2">
                    <input class="form-check-input" type="checkbox" value="Baik" id="kebersihan" name="kebersihan" readonly>
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="d-flex justify-content-start">
            <div class="col-sm-7">
                <div class="row">
                    <textarea name="deskripsi" id="" cols="30" rows="10" class="form-control" readonly></textarea>
                </div>
            </div>
        </div>
