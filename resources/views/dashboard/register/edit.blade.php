...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <form action="{{ route('register.update', ['register' => $users->id]) }}" method="post">
                @csrf
                @method('PUT')
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="form-outline form-white">
                                                            <input type="text" id="form3Examplea9"
                                                                class="form-control form-control-lg" name="employee_status"
                                                                value="{{ $users->employee_status }}" />
