...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Request Test Benang</h1>
    </div>
            ...
            <tbody>
                @foreach ($testBenang as $form)
                    <tr>
                        ...
                        <td>{{ $form->tanggal }}</td>
                        <td>
                            <a href="/dashboard/test-benang/{{ $form->id }}" class="badge bg-info"><span
                                    data-feather="eye"></span></a>
                            <a href="/dashboard/test-benang/{{ $form->id }}/edit" class="badge bg-warning"><span
