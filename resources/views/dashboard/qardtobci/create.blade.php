...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <form action="{{ route('test-benang.store') }}" method="post">
                @csrf
                <div
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="form-outline mb-4">
                                    ...
                                    <textarea class="form-control" id="form4Example3" rows="4" name="kepada"></textarea>
                                </div>
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form4Example3">Dari :</label>
                                    <textarea class="form-control" id="form4Example3" rows="4" name="dari"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="row">
                                <textarea type="text" rows="10" cols="1" name="fab" placeholder="FABRIC PHYSICAL TEST TOP URGENT!"
                                    class="form-control" name="fabric"></textarea>
                            </div>
                        </div>
                    </div>
