        ...
        <table id="table">
            ...
            <tbody>
                ...
                foreach ($data['kd05'] as $row) {
                    ...
                    echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->street1_old ." " . $row->addit1_old. '</td>';
                    echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900"">' . "Street" . '</td>';
                    echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->street1 = ($row->street1 != "") ? $row->street1 . " " . $row->addit1 : '-'. '</td>';
                    echo "</tr>";
                    echo "<tr>";
                    ...
                    echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->email1_old. '</td>';
                    echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900"">' . "Email" . '</td>';
                    ...
                    echo '<td align=left; colspan=3; style="font-size: 10;">' . $row->home1_old. '</td>';
                    echo '<td align=left; colspan=3; style="font-size: 10; font-weight:900"">' . "Home" . '</td>';
